...
Программный интерфейс информационной системы "Карьер" АО "Ковдорский ГОК", 
...
| ------ | ---------------- | ------------ | ---------- | ------------------------------------------ |
| `HTTP` | `10.10.1.1:8088` | `PRODUCTION` | `2.0.0`    | [Ссылка](http://10.10.1.1:8088/index.html) |

- [Структура проекта](#структура-проекта)
  - [Общая структура директории `deploy`](#общая-структура-директории-deploy)
- [Среда разработки](#среда-разработки)
  - [Программное обеспечение](#программное-обеспечение)
  - [Установка Oracle JDBC драйвера (ojdbc8)](#установка-oracle-jdbc-драйвера-ojdbc8)
...
## Установка Oracle JDBC драйвера (ojdbc8)

- Скачать с сайта Oracle JDBC драйвер для версии 12.2.0.1.
- Установить ojdbc8 в локальный репозиторий Maven:

```bash
$ mvn install:install-file -Dfile=path/to/downloaded/ojdbc8.jar -DgroupId=local -DartifactId=ojdbc8 -Dversion=12.2.0.1.0 -Dpackaging=jar
```
